...
ggplot(data,aes(x=reorder(Labels, -value), y=value)) + geom_bar(stat="identity") + theme_minimal() +  theme(axis.title.x=element_blank(), axis.title.y=element_blank(), axis.text.x = element_text(angle =0), text = element_text(size=chart_font_size)) 
